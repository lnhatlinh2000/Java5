<%-- 
    Document   : TTPhongban
    Created on : Jan 16, 2020, 8:19:30 PM
    Author     : ASUS
--%>
                        ...
                        <li><a href="#">Thống kê</a> |
                            <ul class="sub-menu" >
                                ...
                                <li><a style="color: blue;
                                       font-weight: bold;" href="thanhtichPB.htm">Thành tích phòng ban</a></li>
                            </ul>
                        </li>
            ...
            <article>
                <div class="art-tab">
                    ...
                    <table>
                        ...
                        <cLinh:forEach var="pb" items="${PhongBan}">
                            <tr>
                                <td>${pb[0]}</td>
                                <td>${pb[1]}</td>
                                <td>${pb[2]}</td>
